...
/**
 * Generated class for the FluxGivePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-flux-give',
  templateUrl: 'flux-give.html',
})
export class FluxGivePage {
  ...
  //   location.href = "http://c.diancall.com/diancall_web/www/index.html";
  // }
  phoneChange() {
  ...
  presentModal() {
     this.navCtrl.push('FluxGiveSuccessPage',{
