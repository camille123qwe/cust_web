...
import { IonicPage, NavController, NavParams, ModalController, Content,Navbar ,App} from 'ionic-angular';
...
export class GoodsDetailsTwoPage {
  ...
  shopcar='assets/img/icon_gouwuche@2x.png';
    ...
    jihui = 100;
    //------为了活动-----------------------------------------
  constructor(public navCtrl: NavController, public navParams: NavParams, private http: HttpGet, public modalCtrl: ModalController, public zone: NgZone,public app:App) {
    this.goodsdata = this.navParams.data;
    console.log("chenkaixin"+ this.goodsdata);
    this.detilsShow();
    this.cdaward();
  }
